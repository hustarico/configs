...
browser = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'brave' 'google-chrome-stable' 'zen-browser' 'firefox' 'brave' 'chromium' 'microsoft-edge-stable' 'opera' 'librewolf'"
